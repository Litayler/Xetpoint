...
// MFCApplication_list.cpp: определяет поведение классов для приложения.
//

#include "pch.h"
#include "framework.h"
#include "MFCApplication_list.h"
#include "MFCApplication_listDlg.h"
...
// CMFCApplicationlistApp

BEGIN_MESSAGE_MAP(CMFCApplicationlistApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCApplicationlistApp

CMFCApplicationlistApp::CMFCApplicationlistApp()
{
...
// Единственный объект CMFCApplicationlistApp

CMFCApplicationlistApp theApp;


// Инициализация CMFCApplicationlistApp

BOOL CMFCApplicationlistApp::InitInstance()
{
